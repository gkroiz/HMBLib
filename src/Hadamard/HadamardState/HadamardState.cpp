...
#include "HadamardState.hpp"
//template<class Type, Order Ord>
//void HadamardState<Type, Ord>::execute(std::shared_ptr<MatrixData_Old<Type, 'a', Ord>> ptr) {
...
//
//template<class Type, Order Ord>
//void HadamardState<Type, Ord>::execute(std::shared_ptr<MatrixData_Old<Type, 'b', Ord>> ptr) {
