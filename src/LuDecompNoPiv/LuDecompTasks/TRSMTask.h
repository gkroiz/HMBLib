...
template <class Type>
class TRSMTask : public AbstractTask<TRSMData<Type>, TRSMData<Type>> {
public:
    TRSMTask(const std::string_view &name, size_t numberThreads) : AbstractTask<TRSMData<Type>, TRSMData<Type>>(name, numberThreads) {}
    ...
    std::shared_ptr<AbstractTask<TRSMData<Type>, TRSMData<Type>>> copy() override {
